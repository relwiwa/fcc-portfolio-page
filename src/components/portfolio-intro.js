      ...
      <div className="callout secondary">
        <div className="row">
          <div className="column small-12 text-center">
            <h1>Welcome to Walter's <nobr>Portfolio Page!</nobr></h1>
            <p className="lead">I am a Flight Attendant with a Computer Science Minor and a lot more</p>
            <p className="lead">After several years of travelling around the world, I intend to get both feet back on the ground by becoming a Full-Stack Developer</p>
